...
| 9. [Проверка гипотез по увеличению выручки в интернет-магазине. Оценка результатов A/Bтеста]([shop_ hypotheses_test.ipynb](https://github.com/meupsilon/Yandex_practikum/blob/main/shop_%20hypotheses_test.ipynb))|`Интернет-магазины` | `Data Analyst`|`Python` `Pandas` `Matplotlib` `SciPy` `A/B-тестирование` `проверка статистических гипотез`|Анализируем результаты A/B-тестирования в крупном интернет-магазине, приоритизируем гипотезы|Провела приоритезацию гипотез, используя данные интернет-магазина, произведела оценку результатов A/B-тестирования|
